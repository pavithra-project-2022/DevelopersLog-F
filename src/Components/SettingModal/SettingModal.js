...
<div className="modal-content" style={{border:"1px solid red"}}>
<div className="modal-header">
<h5 className="modal-title" style={{color:"red"}}>Setting</h5>
</div>
<div className="modal-body custom_scroll">

<div className="setting-font">
<small className="card-title" style={{color:"red"}}>Google font Settings</small>
<ul className="list-group font_setting mb-3 mt-1">
<li className="list-group-item py-1 px-2">
<div className="form-check mb-0">
<input className="form-check-input" type="radio" name="font" id="font-opensans" value="font-opensans"/>
...
<li className="list-group-item py-1 px-2">
<div className="form-check mb-0">
<input className="form-check-input" type="radio" name="font" id="font-quicksand" value="font-quicksand"/>
...
<li className="list-group-item py-1 px-2">
<div className="form-check mb-0">
<input className="form-check-input" type="radio" name="font" id="font-nunito" value="font-nunito"/>
...
<li className="list-group-item py-1 px-2">
<div className="form-check mb-0">
<input className="form-check-input" type="radio" name="font" id="font-Raleway" value="font-raleway"/>
...
<small className="card-title" style={{color:"red"}}>Theme Color Settings</small>
...
<li data-theme="red" className="active"><div className="red"></div></li>
<li data-theme="dynamic"><div className="dynamic"><i className="fa fa-paint-brush"></i></div></li>
</ul>
</div>
...
<li className="sidebar-img-1 sidebar-img-active"><a className="rounded sidebar-img" id="img-1" href="#"><img src="dashboardAssets/assets/images/sidebar-bg/sidebar-1.jpg" alt="" /></a></li>
<li className="sidebar-img-2"><a className="rounded sidebar-img" id="img-2" href="#"><img src="dashboardAssets/assets/images/sidebar-bg/sidebar-2.jpg" alt="" /></a></li>
<li className="sidebar-img-3"><a className="rounded sidebar-img" id="img-3" href="#"><img src="dashboardAssets/assets/images/sidebar-bg/sidebar-3.jpg" alt="" /></a></li>
<li className="sidebar-img-4"><a className="rounded sidebar-img" id="img-4" href="#"><img src="dashboardAssets/assets/images/sidebar-bg/sidebar-4.jpg" alt="" /></a></li>
<li className="sidebar-img-5"><a className="rounded sidebar-img" id="img-5" href="#"><img src="dashboardAssets/assets/images/sidebar-bg/sidebar-5.jpg" alt="" /></a></li>
</ul>
</div>
</div>
...
<small className="card-title " style={{color:"red"}}>RTL Layout</small>
