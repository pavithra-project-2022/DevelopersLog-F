...
<a href="#" className="me-2 text-muted"><i className="fa fa-facebook-square fa-lg"></i></a>
<a href="#" className="me-2 text-muted"><i className="fa fa-github-square fa-lg"></i></a>
<a href="#" className="me-2 text-muted"><i className="fa fa-linkedin-square fa-lg"></i></a>
<a href="#" className="me-2 text-muted"><i className="fa fa-twitter-square fa-lg"></i></a>
</div>
</div>
</div>
...
<img src="https://alui.thememakker.com/html/assets/images/auth-password-reset.svg" className="w240 mb-4" alt="" />
...
<a href="auth-two-step.html" title="" className="btn btn-lg btn-block btn-dark lift text-uppercase">SUBMIT</a>
</div>
<div className="col-12 text-center mt-4">
<span className="text-muted"><Link to='/'><a href="">Back to Sign in</a></Link></span>
</div>
</form>
